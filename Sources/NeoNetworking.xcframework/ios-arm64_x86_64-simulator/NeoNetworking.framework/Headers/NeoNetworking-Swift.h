...
#ifndef NEONETWORKING_SWIFT_H
#define NEONETWORKING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NeoNetworking",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
typedef SWIFT_ENUM(NSInteger, HTTPStatusCode, open) {
  ...
  HTTPStatusCodeIisLoginTimeout = 440,
  HTTPStatusCodeNginxNoResponse = 444,
  HTTPStatusCodeIisRetryWith = 449,
...
@interface NSHTTPURLResponse (SWIFT_EXTENSION(NeoNetworking))
